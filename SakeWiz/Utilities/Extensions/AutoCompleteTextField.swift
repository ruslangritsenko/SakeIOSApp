...
//  SakeWiz
//
//  Created by welly, TW on 2017/06/01.
...
//        let tableView = UITableView(frame: CGRectMake(self.frame.origin.x, self.frame.origin.y + self.frame.height, screenSize.width - (self.frame.origin.x * 2), 30.0))
        tableView.dataSource = self
        tableView.delegate = self
        tableView.rowHeight = autoCompleteCellHeight
        tableView.isHidden = hidesWhenEmpty ?? true
        
        //Comment this if statement if you want to use this on the base ViewController View
//        if let _ = view.superview
//        {
//            view.superview!.addSubview(tableView)
//        }
        
        //UnComment this line if you want to use this on the bas viewcontroller view
